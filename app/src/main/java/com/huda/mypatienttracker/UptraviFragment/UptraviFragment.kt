package com.huda.mypatienttracker.UptraviFragment
...
class UptraviFragment : Fragment() {
    ...
    private lateinit var uptraviFragmentViewModel: UptraviFragmentViewModel
    ...
    override fun onCreateView(
        ...
        root = inflater.inflate(R.layout.uptravi_patient, container, false)
        uptraviFragmentViewModel =
            ViewModelProviders.of(this).get(UptraviFragmentViewModel::class.java)
        return root
    }
